...
const crearPresupuesto = async(req, res) => {
    try {
        ...
        const movimiento = await cargarMovimientos(req.body.productos, 'PRESUPUESTO', req.body.numeroComprobante, req.body.creadoPor, req.body.tipoCliente, req.body.codigoCliente);
