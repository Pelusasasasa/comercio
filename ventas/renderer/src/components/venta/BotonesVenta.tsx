        ...
        <div className='p-2'>
            <div className='flex items-center justify-between mb-4'>
                ...
                <div className='flex items-center gap-6'>
                    <div className='flex gap-2 items-center'>
                        ...
                        <input type="number" name="recibo" id="recibo" className='border border-gray-400 bg-white rounded-lg px-2 py-1' />
                    </div>
                ...
                <div className='flex items-center gap-4'>
                    <div className='flex gap-2 items-center'>
                        ...
                        <input type="number" name="total" id="total" className='font-bold border border-gray-400 bg-white rounded-lg px-2 py-1' />
                    </div>

                    <div className='flex gap-2 items-center'>
                        <label htmlFor="porcentaje" className='text-sm font-bold text-[#8B4513]'>Porcentaje</label>
                        <input type="number" name="porcentaje" id="porcentaje" className='border border-gray-400 bg-white rounded-lg px-2 py-1' />
                    </div>
                </div>
            ...
            <div className='flex items-center justify-between mb-4'>
                <div className='flex gap-5'>
                    <div className='flex gap-2'>
                        <input type="checkbox" name="impresion" id="impresion" checked className='border rounded-xl scale-125 cursor-pointer' />
                        <label className='text-sm font-bold text-[#8b4513]' htmlFor="impresion">Impresion</label>
                    </div>

                    <div className='flex gap-2'>
                        <input type="checkbox" name="dolar" id="dolar" className='border rounded-xl scale-125 cursor-pointer' />
                        <label className='text-sm font-bold text-[#8b4513]' htmlFor="dolar">Dolar</label>
                    </div>
                </div>

                <div className='flex gap-5'>
                    <Button type='secondary' text='Cancelar' click={() => {}} className='h-10 text-xl'/>
                    <Button  text='Facturar' click={() => {}} className='h-10 text-xl'/>
                </div>
            </div>
        </div>
    </main>
